...
var G = { created() {
  ...
  let e = this.$options.remember.key instanceof Function ? this.$options.remember.key.call(this) : this.$options.remember.key, r = Qr.restore(e), n = this.$options.remember.data.filter((o) => !(this[o] !== null && typeof this[o] == "object" && this[o].__rememberable === false)), s = (o) => this[o] !== null && typeof this[o] == "object" && typeof this[o].__remember == "function" && typeof this[o].__restore == "function";
  n.forEach((o) => {
    this[o] !== void 0 && r !== void 0 && r[o] !== void 0 && (s(o) ? this[o].__restore(r[o]) : this[o] = r[o]), this.$watch(o, () => {
      Qr.remember(n.reduce((a, l) => ({ ...a, [l]: cloneDeep(s(l) ? this[l].__remember() : this[l]) }), {}), e);
    }, { immediate: true, deep: true });
  });
} };
var V = G;
function x(e, r) {
  let n = typeof e == "string" ? e : null, s = (typeof e == "string" ? r : e) ?? {}, o = n ? Qr.restore(n) : null, a = typeof s == "function" ? cloneDeep(s()) : cloneDeep(s), l = null, f = null, m = (t) => t, v = reactive({ ...o ? o.data : cloneDeep(a), isDirty: false, errors: o ? o.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let i = typeof t[0] == "object", h2 = i ? t[0].method : t[0], p = i ? t[0].url : t[1], u = (i ? t[1] : t[2]) ?? {}, F = m(this.data()), T = { ...u, onCancelToken: (c) => {
    ...
    h2 === "delete" ? Qr.delete(p, { ...T, data: F }) : Qr[h2](p, F, T);
  }, get(t, i) {
    this.submit("get", t, i);
  }, post(t, i) {
  ...
  return watch(v, (t) => {
    v.isDirty = !isEqual(v.data(), a), n && Qr.remember(cloneDeep(t.__remember()), n);
...
var ie = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  y.value = r ? markRaw(r) : null, d.value = e, A.value = null;
  let a = typeof window > "u";
  return E = Oe(a, s, o), a || (Qr.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    y.value = markRaw(l.component), d.value = l.page, A.value = l.preserveState ? A.value : Date.now();
  } }), Qr.on("navigate", () => E.forceUpdate())), () => {
    if (y.value) {
...
var B = ie;
var q = { install(e) {
  Qr.form = x, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Qr }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => d.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => E }), e.mixin(V);
} };
function ae() {
...
async function K({ id: e = "app", resolve: r, setup: n, title: s, progress: o = {}, page: a, render: l }) {
  let f = typeof window > "u", m = f ? null : document.getElementById(e), v = a || JSON.parse(m.dataset.page), t = (p) => Promise.resolve(r(p)).then((u) => u.default || u), i = [], h2 = await Promise.all([t(v.component), Qr.decryptHistory().catch(() => {
  ...
  if (!f && o && Ne(o), f) {
    let p = await l(createSSRApp({ render: () => h("div", { id: e, "data-page": JSON.stringify(v), innerHTML: h2 ? l(h2) : "" }) }));
...
var Te = defineComponent({ name: "Link", props: { as: { type: String, default: "a" }, data: { type: Object, default: () => ({}) }, href: { type: [String, Object], required: true }, method: { type: String, default: "get" }, replace: { type: Boolean, default: false }, preserveScroll: { type: Boolean, default: false }, preserveState: { type: Boolean, default: null }, only: { type: Array, default: () => [] }, except: { type: Array, default: () => [] }, headers: { type: Object, default: () => ({}) }, queryStringArrayFormat: { type: String, default: "brackets" }, async: { type: Boolean, default: false }, prefetch: { type: [Boolean, String, Array], default: false }, cacheFor: { type: [Number, String, Array], default: 0 }, onStart: { type: Function, default: (e) => {
  ...
  let f = typeof e.href == "object" ? e.href.method : e.method.toLowerCase(), m = f !== "get" ? "button" : e.as.toLowerCase(), v = computed(() => Ce(f, typeof e.href == "object" ? e.href.url : e.href || "", e.data, e.queryStringArrayFormat)), t = computed(() => v.value[0]), i = computed(() => v.value[1]), h2 = computed(() => ({ a: { href: t.value }, button: { type: "button" } })), p = { data: i.value, method: f, replace: e.replace, preserveScroll: e.preserveScroll, preserveState: e.preserveState ?? f !== "get", only: e.only, except: e.except, headers: e.headers, async: e.async }, u = { ...p, onCancelToken: e.onCancelToken, onBefore: e.onBefore, onStart: (g) => {
    s.value++, e.onStart(g);
  }, onProgress: e.onProgress, onFinish: (g) => {
    s.value--, e.onFinish(g);
  }, onCancel: e.onCancel, onSuccess: e.onSuccess, onError: e.onError }, F = () => {
    Qr.prefetch(t.value, p, { cacheFor: l });
  }, T = { onClick: (g) => {
    $e(g) && (g.preventDefault(), Qr.visit(t.value, u));
  } }, c = { onMouseenter: () => {
    o.value = setTimeout(() => {
      F();
    }, 75);
    ...
    $e(g) && (g.preventDefault(), F());
  }, onMouseup: (g) => {
    g.preventDefault(), Qr.visit(t.value, u);
  }, onClick: (g) => {
    $e(g) && g.preventDefault();
  } };
  return () => h(m, { ...n, ...h2.value[m] || {}, "data-loading": s.value > 0 ? "" : void 0, ...a.includes("hover") ? c : a.includes("click") ? w : T }, r);
} });
var Se = Te;
function W(e, r = {}, n = { keepAlive: false, autoStart: true }) {
  let { stop: s, start: o } = Qr.poll(e, r, { ...n, autoStart: false });
  return onMounted(() => {
    (n.autoStart ?? true) && o();
  }), onUnmounted(() => {
    s();
...
function J(e = {}) {
  let r = ref(false), n = ref(null), s = ref(false), o = typeof window > "u" ? null : Qr.getCached(window.location.pathname, e), a = typeof window > "u" ? null : Qr.getPrefetching(window.location.pathname, e);
  n.value = (o == null ? void 0 : o.staleTimestamp) || null, r.value = a !== null, s.value = o !== null;
  let l, f;
  return onMounted(() => {
    f = Qr.on("prefetching", (m) => {
      m.detail.visit.url.pathname === window.location.pathname && (r.value = true);
    }), l = Qr.on("prefetched", (m) => {
      m.detail.visit.url.pathname === window.location.pathname && (r.value = false, s.value = true);
    });
  }), onUnmounted(() => {
    l(), f();
  }), { lastUpdatedAt: n, isPrefetching: r, isPrefetched: s, flush: () => Qr.flush(window.location.pathname, e) };
}
function Q(e, r) {
  if (typeof e == "object" && e !== null && e.__rememberable === false) return e;
  let n = Qr.restore(r), s = isReactive(e) ? reactive : ref, o = typeof e.__remember == "function" && typeof e.__restore == "function", a = s(n === void 0 ? e : o ? e.__restore(n) : n);
  return watch(a, (l) => {
    Qr.remember(cloneDeep(o ? e.__remember() : l), r);
