...
function normalizeDates(application, formFields) {
...
const form = useForm(
  normalizeDates(props.application, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.application.id), {
