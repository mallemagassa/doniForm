...
function normalizeDates(evaluation, formFields) {
...
const form = useForm(
  normalizeDates(props.evaluation, props.form)
)

function submitForm() {
  form.put(props.resource.routes.update.replace(':id', props.evaluation.id), {
